...
app = Flask(__name__)
api = Api(app)
# changing config file, DB = DB Name
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///database.db'
db = SQLAlchemy(app)

# need to delete the line below after running it for the first time.
# db.create_all()
...
# what to grab, what type it is, what to display if incorrect, required if desired
